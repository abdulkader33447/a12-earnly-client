...
const PurchaseCoin = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <h1 className="text-3xl font-bold text-center mb-6">Purchase Coins</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {coinPackages.map(({ coins, price }) => (
          <div
            key={coins}
            className="bg-gradient-to-tl from-blue-50 to-green-50  rounded-2xl shadow-[_0_0_8px_blue-50] p-6 text-center border border-gray-200 hover:shadow-2xl transition duration-300"
          >
            ...
            <button
              ...
              className="btn btn-outline mt-4 px-5 py-2 text-[#fca61b] hover:text-white rounded-full hover:bg-[#fca61b] transition"
            >
              Buy Now
            </button>
          </div>
