  ...
  return (
    <div className="sm:bg-linear-to-r bg-linear-to-t from-yellow-50 to-blue-50">
      <div className="lg:w-8/12 md:w-10/12 w-11/12 mx-auto lg:py-20 md:py-14 py-10">
        <div className=" p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-10 mt-16 max-w-5xl mx-auto">
          {/* Left Content */}
          ...
          <div className="flex-1 flex justify-center">
            ...
            <img
              ...
              alt="Mobile Teaser"
              className="w-[200px] md:w-[260px] rounded-xl sm:block hidden ml-2"
            />
          </div>
        </div>
      </div>
